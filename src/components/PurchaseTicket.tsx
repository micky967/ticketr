    ...
    <div className="bg-white p-6 rounded-xl shadow-lg border border-amber-300">
      <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-black font-bold">
                  Expires In : <span className="text-green-500 text-sm font-bold">{timeRemaining}</span>
                </p>
              </div>
            </div>
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-amber-300 to-amber-700 text-white px-8 py-4 rounded-lg font-bold shadow-md hover:from-amber-500 hover:to-amber-700 transform hover:scale-[1.02] transition-all duration-200 disabled:from-gray-400 disabled:to-gray-500 disabled:cursor-not-allowed disabled:hover:scale-100 text-lg"
        >
          {isLoading
